...
class TextArea(widget.Widget):
    ...
    def paint(self, s):
        ...
        # TODO: What's up with this 20 magic number? It's the margin of the left and right sides, but I'm not sure
        # how this should be gotten other than by trial and error.
    ...
    def doLines(self, max_line_w):
        ...
        while inx >= 0:
            ...
            # If we reached a hard line break
                ...
                # HACK: We know we have a newline character, which doesn't print nicely, so make it into a space.
    ...
    def event(self, e):
        ...
        if e.type == KEYDOWN:
            ...
            # used = True
                ...
                self.vpos += 1
                self.setCursorByHVPos()
                # The following return/tab keys are standard for PGU widgets, but I took them out here to facilitate
